 ...
 *
 * @link              natebarlowjr.com
 * @since             1.0.0
 * @package           Wp_Cbf
 *
 * @wordpress-plugin
 * Plugin Name:       WP Cleanup and Base Functions
 * Plugin URI:        https://github.com/n8bar/wp-cleanup-and-base-functions
 * Description:       Head section cleanup and manu usual custom settings used on every website setup as imagessettings, privacy and basic admin customizations
 * Version:           1.0.0
 * Author:            Nate Barlow
 * Author URI:        natebarlowjr.com
 * License:           GPL-2.0+
